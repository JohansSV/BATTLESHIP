...
def options():
    ...
    selected_option = "Mouse"  # Ninguna opción seleccionada al inicio
    ...
    while True:
        ...
        mouse_checkbox_rect = pygame.Rect(550, 300, 30, 30)  # Checkbox para "Mouse"
        gamepad_checkbox_rect = pygame.Rect(550, 350, 30, 30)  # Checkbox para "Gamepad"
        ...
        SCREEN.blit(mouse_text, (600, 295))
        SCREEN.blit(gamepad_text, (600, 345))
